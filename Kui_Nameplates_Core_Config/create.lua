...
function classpowers:Initialise()
    ...
    local classpowers_colour_supercharged = self:CreateColourPicker('classpowers_colour_supercharged')
    local classpowers_colour_supercharged_active = self:CreateColourPicker('classpowers_colour_supercharged_active')
    local classpowers_colour_additional_active = self:CreateColourPicker('classpowers_colour_additional_active')
    ...
    classpowers_colour:SetPoint('LEFT',classpowers_enable,220,0)
    ...
    classpowers_colour_supercharged:SetPoint('TOP',classpowers_colour_inactive,'BOTTOM')
    classpowers_colour_supercharged_active:SetPoint('TOP',classpowers_colour_supercharged,'BOTTOM')
    classpowers_colour_additional_active:SetPoint('TOP',classpowers_colour_supercharged_active,'BOTTOM')
    ...
    classpowers_colour_supercharged.enabled = classpowers_enabled
    classpowers_colour_supercharged_active.enabled = classpowers_enabled
    classpowers_colour_additional_active.enabled = classpowers_enabled
